...
const fs = require('fs');
const packageJson = require('./package.json'); // Cargar packag>
...
// Rutas
app.get('/', (req, res) => {
    res.send(`Bienvenido a ${packageJson.name} - Versión: ${pac>
});

// Iniciar el servidor
app.listen(PORT, () => {
    console.log(`${packageJson.name} está corriendo en http://l>
});
